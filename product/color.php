...
$colr = mysqli_query($mysqli, "SELECT * FROM `colors`");
 ...
 if(isset($_POST['addColor'])) {
    ...
    mysqli_query($mysqli, "INSERT INTO `colors`(`color`) VALUES ('$color')");
 ...
 if(isset($_POST['delColor'])) {
    ...
    mysqli_query($mysqli, "DELETE FROM `colors` WHERE `id` = '$delColr'");
    header("Location: " . $_SERVER['HTTP_REFERER']);
 }
?>
<!DOCTYPE html>
...
<body>
    ...
    <main class="main">
        <div class="container">
            ...
            <form action="color.php" method="post" style="max-width: 1000px; margin: 0 auto;">
