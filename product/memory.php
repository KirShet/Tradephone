...
// }
$colr = mysqli_query($mysqli, "SELECT * FROM `memory`");
 // добавление цвета
 if(isset($_POST['addColor'])) {
    $color = $_POST['nameColor'];

    mysqli_query($mysqli, "INSERT INTO `memory`(`ROM`) VALUES ('$color')");
 ...
 if(isset($_POST['delColor'])) {
    ...
    mysqli_query($mysqli, "DELETE FROM `memory` WHERE `id` = '$delColr'");
    header("Location: " . $_SERVER['HTTP_REFERER']);
 }
?>
<!DOCTYPE html>
...
<body>
    ...
    <main class="main">
        <div class="container">
            ...
            <form action="memory.php" method="post" style="max-width: 1000px; margin: 0 auto;">
